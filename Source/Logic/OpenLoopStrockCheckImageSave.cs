...
namespace FZ4P
{
    public class OpenLoopStrockCheckImageSave : IOpenLoopExecutor,ISetSavePath
    {
        ...
        private string saveImageDir = "C:\\6AxisTester\\Result\\Image\\AFHalCal\\";

        public OpenLoopStrockCheckImageSave(MILlib Cam, FVision vision, AK73XX driveIC, LogText logText,Global global)
        {
            _cam = Cam;
            _vision = vision;
            _driveIC = driveIC;
        ...
        public void Execute(int iCh)
        {
            ...
            Directory.Delete(saveImageDir, true);
            ...
            {
                OldStroke = NewStroke;
                _driveIC.AFMove(iCh, STATIC.Rcp.Condition.iAFOpenLoopMax);
                Wait(50);
                tmpres = Measure(0);
                Wait(50);
                zVal[0] = tmpres.cz[0];
